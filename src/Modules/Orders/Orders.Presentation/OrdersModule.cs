...
namespace Orders.Presentation
{
    public class OrdersModule : IModule
    {
        ...
        private IServiceCollection AddInfrastructure(IServiceCollection services, IConfiguration configuration)
        {
            services.AddDbContext<OrdersDbContext>(opt => opt.UseNpgsql(configuration.GetConnectionString("OrdersDb")));
